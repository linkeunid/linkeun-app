...
// Factory function to create server API client instances
export const createServerApiClient = (sessionToken?: string): ServerApiClient => {
	return new ServerApiClient(sessionToken);
};