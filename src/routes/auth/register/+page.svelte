...
<svelte:head>
	<title>Register - LinkeunApp</title>
	<meta
		name="description"
		content="Create a new LinkeunApp account to get started with our platform and access exclusive features."
	/>
	<meta property="og:title" content="Register - LinkeunApp" />
	<meta
