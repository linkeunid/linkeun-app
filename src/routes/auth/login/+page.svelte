...
<svelte:head>
	<title>Login - LinkeunApp</title>
	<meta
		name="description"
		content="Sign in to your LinkeunApp account to access personalized features and content."
	/>
	<meta property="og:title" content="Login - LinkeunApp" />
	<meta
